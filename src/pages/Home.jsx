          ...
          <ul className="navbar-nav list-unstyled d-flex flex-row gap-3 gap-lg-5 justify-content-center flex-wrap align-items-center mb-0 fw-bold text-uppercase text-dark">
            ...
            <li className="nav-item dropdown">
              ...
              >
                ...
                <li>
                  <a href="singlep" className="dropdown-item">
                    Single Post
                  </a>
                </li>
          ...
          <div className="row my-5">
            <div className="col">
              <div className="row text-dark">
                ...
                <div className="col">
                  <p className="text-uppercase lh-sm mb-0">Product<br></br> Varieties</p>
                </div>
              </div>
            </div>
            <div className="col">
              <div className="row text-dark">
                ...
                <div className="col">
                  <p className="text-uppercase lh-sm mb-0">Happy<br></br> Customers</p>
                </div>
              </div>
            </div>
            <div className="col">
              <div className="row text-dark">
                ...
                <div className="col">
                  <p className="text-uppercase lh-sm mb-0">Store<br></br> Locations</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="row">
              ...
              <div className="col-md-9">
                <div className="card-body p-0">
                  <h5 className="text-light">Can be Recyle</h5>
        ...
        <div className="col">
          <div className="card border-0 bg-secondary rounded-0 p-4 text-light">
            <div className="row">
              ...
              <div className="col-md-9">
                <div className="card-body p-0">
                  <h5 className="text-light">Environment Friendly</h5>
                  <p className="card-text">
                    Lorem ipsum dolor sit amet, consectetur adipi elit.
                  </p>
                </div>
